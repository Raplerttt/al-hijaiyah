              ...
              <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                <div className="flex items-start">
                  <div className="shrink-0">
                    <div className="inline-block rounded-md bg-teal-400/10 p-4 text-teal-700">
                      <svg
                    ...
                    <div className="inline-block rounded-md bg-teal-400/10 p-4 text-teal-700">
                      ...
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          d="M9.75 17L15 12.75m-2.25-2.25L15 21m-7.5-6L3 9.75M12 3v.75m9 9.75a9 9 0 11-18 0 9 9 0 0118 0z"
                        />
                      </svg>
                    </div>
                  </div>
